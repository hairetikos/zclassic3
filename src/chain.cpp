...
void CBlockIndex::TrimSolution()
{
    ...
    if (HasSolution()) {
        MetricsIncrementCounter("zclassicd.debug.memory.trimmed_equihash_solutions");
...
CBlockHeader CBlockIndex::GetBlockHeader() const
{
    ...
    if (HasSolution()) {
        ...
        MetricsIncrementCounter("zclassicd.debug.blocktree.trimmed_equihash_read_dbindex");
