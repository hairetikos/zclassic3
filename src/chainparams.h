...
public:
     ...
     * `sprout` regtest cache, which was generated by a zclassicd version older
    ...
    /** Return the BIP44 coin type for addresses created by the zclassicd embedded wallet. */
