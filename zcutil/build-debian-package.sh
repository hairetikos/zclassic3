...
cp $SRC_PATH/src/zclassicd-wallet-tool $DEB_BIN
...
cp $SRC_DOC/man/zclassicd-wallet-tool.1 $DEB_MAN
...
gzip --best -n $DEB_MAN/zclassicd-wallet-tool.1
...
dpkg-shlibdeps $DEB_BIN/zclassicd $DEB_BIN/zclassic-cli
